...
const WhyFibre = () => {
    ...
    return (
        <section id="why" className="relative">
            <img
                src={images.BG_WHT_1}
                className="w-full h-[1400px] md:h-[578px] brightness-[0.3] object-cover"
            />
            <div className="absolute inset-0 z-10 text-white py-20">
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-x-32">
                        ...
                        <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 md:mt-0">
